...
In this case, the variable score is declared and assigned the value 10. */

//If you want to update the value later, you can easily do that:
let score = 10;
console.log(score); // 10
score = 20;
console.log(score); // 20

//Now, score holds the value 20. This makes let particularly useful when 
// you know the value of a variable will change as your program runs.
...
//Trying to reassign a value to a const variable will throw an error in your JavaScript console, as const variables are 
// immutable once they are assigned.
...
1. What happens if you try to reassign a value to a variable declared with const?
...
2. Which of the following is the correct way to assign the number 100 to a constant named maxScore?
...
3. Can you declare a const variable without assigning it a value?
